...
urlpatterns = [
    ...
    path('chats/<uuid:chat_id>/pinned/', ChatPinnedMessagesView.as_view()),
    ...
    path('chats/<uuid:chat_id>/messages/<uuid:message_id>/pin/', ChatMessagePinView.as_view()),

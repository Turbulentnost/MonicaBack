...
# Отдельный префикс, чтобы не пересекаться со static CRA на том же домене
...
CALL_RING_TIMEOUT_SEC = int(os.getenv('CALL_RING_TIMEOUT_SEC', '30'))
TURN_HOST = os.getenv('TURN_HOST', '').strip()
TURN_SECRET = os.getenv('TURN_SECRET', '')
TURN_REALM = os.getenv('TURN_REALM', 'monica')
TURN_CREDENTIAL_TTL = int(os.getenv('TURN_CREDENTIAL_TTL', '3600'))
...
AI_PARTNER_STYLE_EVERY_N = int(os.getenv('AI_PARTNER_STYLE_EVERY_N', '2'))
AI_PARTNER_STYLE_DEBOUNCE_SEC = int(os.getenv('AI_PARTNER_STYLE_DEBOUNCE_SEC', '45'))
